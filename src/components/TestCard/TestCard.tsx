    ...
    >
      <div className="p-6 flex-grow">
        <div className="flex justify-between items-center mb-4">
          ...
          <span className="text-xs font-medium text-gray-500 bg-gray-100 px-2.5 py-1 rounded-full flex items-center">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-3 leading-tight">{test.title}</h2>
        <p className="text-gray-600 text-sm leading-relaxed mb-4">{test.description}</p>
      </div>
      ...
      <div className="bg-gray-50 px-6 py-4 flex justify-between items-center border-t border-gray-100">
        ...
        <button 
          ...
          className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded-lg transition-colors text-sm flex items-center"
        >
          Comenzar
